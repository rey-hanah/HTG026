For the map page we are going to have the map on the right side with a side bar on left with cards within in it.

# sidebar

- this is gonna be sth similar to https://ui.shadcn.com/docs/components/radix/sidebar but not this exactly cuz instead of items to expand there is going to be cards. In each card there should be details about :Distance in meters/km and how far walking away
  Rate for paid parking (e.g., "
  6.50
  /
  h
  r
  ...
  ,
  6.50/hr(9am−6pm),4.00/hr (6pm-10pm)")
  Time limit for free (e.g., "Max 2 Hr (9am-6pm), 4 Hr (6pm-10pm)")
  EV charger count and operator
  AI availability prediction
  "Open in Google Maps/Maps" button
  you could use following card inspo:
  there could be pics and the name of the place and then other details appear after hovering over it on the side bar. the same minimal design card should be appearing when a person hovers over the dot on the map but this time, without animation of appearing, just the solid card.
...
on the side bar on the left, on top of it should be the searching bar, and the slider for radious and check boxes for free, paid, ev.
